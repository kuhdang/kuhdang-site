...
void main() {
	...
	`}function Mp(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===fa||l===pa,h=l===Pi||l===Di;if(c||h){let u=e.get(o);const d=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new Va(i)),u=c?t.fromEquirectangular(o,u):t.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),u.texture;if(u!==void 0)return u.texture;{const m=o.image;return c&&m&&m.height>0||h&&m&&s(m)?(t===null&&(t=new Va(i)),u=c?t.fromEquirectangular(o):t.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),o.addEventListener("dispose",r),u.texture):null}}}return o}function s(o){let l=0;const c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function r(o){const l=o.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function wp(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&Ws("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function bp(i,e,t,n){const s={},r=new WeakMap;function a(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const x=d.morphAttributes[g];for(let p=0,f=x.length;p<f;p++)e.remove(x[p])}d.removeEventListener("dispose",a),delete s[d.id];const m=r.get(d);m&&(e.remove(m),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(u,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,t.memory.geometries++),d}function l(u){const d=u.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const m=u.morphAttributes;for(const g in m){const x=m[g];for(let p=0,f=x.length;p<f;p++)e.update(x[p],i.ARRAY_BUFFER)}}function c(u){const d=[],m=u.index,g=u.attributes.position;let x=0;if(m!==null){const w=m.array;x=m.version;for(let M=0,E=w.length;M<E;M+=3){const F=w[M+0],C=w[M+1],T=w[M+2];d.push(F,C,C,T,T,F)}}else if(g!==void 0){const w=g.array;x=g.version;for(let M=0,E=w.length/3-1;M<E;M+=3){const F=M+0,C=M+1,T=M+2;d.push(F,C,C,T,T,F)}}else return;const p=new(lc(d)?mc:pc)(d,1);p.version=x;const f=r.get(u);f&&e.remove(f),r.set(u,p)}function h(u){const d=r.get(u);if(d){const m=u.index;m!==null&&d.version<m.version&&c(u)}else c(u);return r.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function Ep(i,e,t){let n;function s(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function l(d,m){i.drawElements(n,m,r,d*a),t.update(m,n,1)}function c(d,m,g){g!==0&&(i.drawElementsInstanced(n,m,r,d*a,g),t.update(m,n,g))}function h(d,m,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,r,d,0,g);let p=0;for(let f=0;f<g;f++)p+=m[f];t.update(p,n,1)}function u(d,m,g,x){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let f=0;f<d.length;f++)c(d[f]/a,m[f],x[f]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,r,d,0,x,0,g);let f=0;for(let w=0;w<g;w++)f+=m[w];for(let w=0;w<x.length;w++)t.update(f,n,x[w])}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Tp(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Ap(i,e,t){const n=new WeakMap,s=new ot;function r(a,o,l){const c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(o);if(d===void 0||d.count!==u){let v=function(){U.dispose(),n.delete(o),o.removeEventListener("dispose",v)};var m=v;d!==void 0&&d.texture.dispose();const g=o.morphAttributes.position!==void 0,x=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,f=o.morphAttributes.position||[],w=o.morphAttributes.normal||[],M=o.morphAttributes.color||[];let E=0;g===!0&&(E=1),x===!0&&(E=2),p===!0&&(E=3);let F=o.attributes.position.count*E,C=1;F>e.maxTextureSize&&(C=Math.ceil(F/e.maxTextureSize),F=e.maxTextureSize);const T=new Float32Array(F*C*4*u),U=new hc(T,F,C,u);U.type=xn,U.needsUpdate=!0;const Q=E*4;for(let y=0;y<u;y++){const V=f[y],B=w[y],Y=M[y],Z=F*C*4*y;for(let G=0;G<V.count;G++){const K=G*Q;g===!0&&(s.fromBufferAttribute(V,G),T[Z+K+0]=s.x,T[Z+K+1]=s.y,T[Z+K+2]=s.z,T[Z+K+3]=0),x===!0&&(s.fromBufferAttribute(B,G),T[Z+K+4]=s.x,T[Z+K+5]=s.y,T[Z+K+6]=s.z,T[Z+K+7]=0),p===!0&&(s.fromBufferAttribute(Y,G),T[Z+K+8]=s.x,T[Z+K+9]=s.y,T[Z+K+10]=s.z,T[Z+K+11]=Y.itemSize===4?s.w:1)}}d={count:u,texture:U,size:new j(F,C)},n.set(o,d),o.addEventListener("dispose",v)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let g=0;for(let p=0;p<c.length;p++)g+=c[p];const x=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",x),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function Cp(i,e,t,n){let s=new WeakMap;function r(l){const c=n.render.frame,h=l.geometry,u=e.get(l,h);if(s.get(u)!==c&&(e.update(u),s.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;s.get(d)!==c&&(d.update(),s.set(d,c))}return u}function a(){s=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}class Sc extends Lt{constructor(e,t,n,s,r,a,o,l,c,h=Ti){if(h!==Ti&&h!==Ii)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Ti&&(n=ni),n===void 0&&h===Ii&&(n=Li),super(null,s,r,a,o,l,h,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Xt,this.minFilter=l!==void 0?l:Xt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const yc=new Lt,nl=new Sc(1,1),Mc=new hc,wc=new pu,bc=new _c,il=[],sl=[],rl=new Float32Array(16),al=new Float32Array(9),ol=new Float32Array(4);function Bi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=il[s];if(r===void 0&&(r=new Float32Array(s),il[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function pt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function mt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function ar(i,e){let t=sl[e];t===void 0&&(t=new Int32Array(e),sl[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Rp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Pp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(pt(t,e))return;i.uniform2fv(this.addr,e),mt(t,e)}}function Dp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(pt(t,e))return;i.uniform3fv(this.addr,e),mt(t,e)}}function Lp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(pt(t,e))return;i.uniform4fv(this.addr,e),mt(t,e)}}function Ip(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(pt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),mt(t,e)}else{if(pt(t,n))return;ol.set(n),i.uniformMatrix2fv(this.addr,!1,ol),mt(t,n)}}function Up(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(pt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),mt(t,e)}else{if(pt(t,n))return;al.set(n),i.uniformMatrix3fv(this.addr,!1,al),mt(t,n)}}function Np(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(pt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),mt(t,e)}else{if(pt(t,n))return;rl.set(n),i.uniformMatrix4fv(this.addr,!1,rl),mt(t,n)}}function Fp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Op(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(pt(t,e))return;i.uniform2iv(this.addr,e),mt(t,e)}}function zp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(pt(t,e))return;i.uniform3iv(this.addr,e),mt(t,e)}}function Bp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(pt(t,e))return;i.uniform4iv(this.addr,e),mt(t,e)}}function kp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Hp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(pt(t,e))return;i.uniform2uiv(this.addr,e),mt(t,e)}}function Gp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(pt(t,e))return;i.uniform3uiv(this.addr,e),mt(t,e)}}function Vp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(pt(t,e))return;i.uniform4uiv(this.addr,e),mt(t,e)}}function Wp(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(nl.compareFunction=oc,r=nl):r=yc,t.setTexture2D(e||r,s)}function Xp(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||wc,s)}function qp(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||bc,s)}function Yp(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Mc,s)}function $p(i){switch(i){case 5126:return Rp;case 35664:return Pp;case 35665:return Dp;case 35666:return Lp;case 35674:return Ip;case 35675:return Up;case 35676:return Np;case 5124:case 35670:return Fp;case 35667:case 35671:return Op;case 35668:case 35672:return zp;case 35669:case 35673:return Bp;case 5125:return kp;case 36294:return Hp;case 36295:return Gp;case 36296:return Vp;case 35678:case 36198:case 36298:case 36306:case 35682:return Wp;case 35679:case 36299:case 36307:return Xp;case 35680:case 36300:case 36308:case 36293:return qp;case 36289:case 36303:case 36311:case 36292:return Yp}}function Kp(i,e){i.uniform1fv(this.addr,e)}function Zp(i,e){const t=Bi(e,this.size,2);i.uniform2fv(this.addr,t)}function Jp(i,e){const t=Bi(e,this.size,3);i.uniform3fv(this.addr,t)}function jp(i,e){const t=Bi(e,this.size,4);i.uniform4fv(this.addr,t)}function Qp(i,e){const t=Bi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function em(i,e){const t=Bi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function tm(i,e){const t=Bi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function nm(i,e){i.uniform1iv(this.addr,e)}function im(i,e){i.uniform2iv(this.addr,e)}function sm(i,e){i.uniform3iv(this.addr,e)}function rm(i,e){i.uniform4iv(this.addr,e)}function am(i,e){i.uniform1uiv(this.addr,e)}function om(i,e){i.uniform2uiv(this.addr,e)}function lm(i,e){i.uniform3uiv(this.addr,e)}function cm(i,e){i.uniform4uiv(this.addr,e)}function hm(i,e,t){const n=this.cache,s=e.length,r=ar(t,s);pt(n,r)||(i.uniform1iv(this.addr,r),mt(n,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||yc,r[a])}function um(i,e,t){const n=this.cache,s=e.length,r=ar(t,s);pt(n,r)||(i.uniform1iv(this.addr,r),mt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||wc,r[a])}function dm(i,e,t){const n=this.cache,s=e.length,r=ar(t,s);pt(n,r)||(i.uniform1iv(this.addr,r),mt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||bc,r[a])}function fm(i,e,t){const n=this.cache,s=e.length,r=ar(t,s);pt(n,r)||(i.uniform1iv(this.addr,r),mt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Mc,r[a])}function pm(i){switch(i){case 5126:return Kp;case 35664:return Zp;case 35665:return Jp;case 35666:return jp;case 35674:return Qp;case 35675:return em;case 35676:return tm;case 5124:case 35670:return nm;case 35667:case 35671:return im;case 35668:case 35672:return sm;case 35669:case 35673:return rm;case 5125:return am;case 36294:return om;case 36295:return lm;case 36296:return cm;case 35678:case 36198:case 36298:case 36306:case 35682:return hm;case 35679:case 36299:case 36307:return um;case 35680:case 36300:case 36308:case 36293:return dm;case 36289:case 36303:case 36311:case 36292:return fm}}class mm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=$p(t.type)}}class gm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=pm(t.type)}}class vm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const kr=/(\w+)(\])?(\[|\.)?/g;function ll(i,e){i.seq.push(e),i.map[e.id]=e}function _m(i,e,t){const n=i.name,s=n.length;for(kr.lastIndex=0;;){const r=kr.exec(n),a=kr.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){ll(t,c===void 0?new mm(o,i,e):new gm(o,i,e));break}else{let u=t.map[o];u===void 0&&(u=new vm(o),ll(t,u)),t=u}}}class Xs{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);_m(r,a,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function cl(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const xm=37297;let Sm=0;function ym(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}function Mm(i){const e=Ye.getPrimaries(Ye.workingColorSpace),t=Ye.getPrimaries(i);let n;switch(e===t?n="":e===js&&t===Js?n="LinearDisplayP3ToLinearSRGB":e===Js&&t===js&&(n="LinearSRGBToLinearDisplayP3"),i){case bn:case sr:return[n,"LinearTransferOETF"];case Qt:case ro:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function hl(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const a=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+ym(i.getShaderSource(e),a)}else return s}function wm(i,e){const t=Mm(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function bm(i,e){let t;switch(e){case Xl:t="Linear";break;case ql:t="Reinhard";break;case Yl:t="Cineon";break;case Ja:t="ACESFilmic";break;case $l:t="AgX";break;case Kl:t="Neutral";break;case Dh:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Is=new A;function Em(){Ye.getLuminanceCoefficients(Is);const i=Is.x.toFixed(4),e=Is.y.toFixed(4),t=Is.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function Um(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Gl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Vl?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===mn&&(e="SHADOWMAP_TYPE_VSM"),e}function Nm(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Pi:case Di:e="ENVMAP_TYPE_CUBE";break;case ir:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Fm(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Di:e="ENVMAP_MODE_REFRACTION";break}return e}function Om(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Wl:e="ENVMAP_BLENDING_MULTIPLY";break;case Rh:e="ENVMAP_BLENDING_MIX";break;case Ph:e="ENVMAP_BLENDING_ADD";break}return e}function zm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Bm(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Um(t),c=Nm(t),h=Fm(t),u=Om(t),d=zm(t),m=Tm(t),g=Am(r),x=s.createProgram();let p,f,w=t.glslVersion?"#version "+t.glslVersion+`
...
`;function Wg(i){const e=1/re.baseFreq;let t=1;for(;t<go&&e/Math.pow(re.lacunarity,t)>2.5*i;)t++;return t}function Xg(i,e,t){const n=(e*.9).toFixed(4),s=t?`
...
`;return{header:r,normalChunk:a,positionChunk:o}}function qg(i,e,t,n){const{header:s,normalChunk:r,positionChunk:a}=Xg(e,t,n);i.vertexShader=s+i.vertexShader,i.vertexShader=i.vertexShader.replace("#include <beginnormal_vertex>",r).replace("#include <begin_vertex>",a)}const Yg=i=>`
${or()}
${i>0?Uc(i):""}
${zc}
${cs}
...
`;function Al({heightBias:i=0,polygonOffset:e=0,spacing:t=.25,useDeform:n=!0,microDetail:s=!0,sparkle:r=!0,sunShadowSteps:a=24}={}){const o=new Dc({color:new pe("#e9eefc"),roughness:.72,metalness:0,envMapIntensity:.85,dithering:!0,polygonOffset:e!==0,polygonOffsetFactor:e,polygonOffsetUnits:e*2});return o.onBeforeCompile=l=>{vo(l,Vg),l.uniforms.uSSSColor={value:I.sssColor},l.uniforms.uShadowTint={value:I.shadowTint},l.uniforms.uSunTint={value:I.sunTint},l.uniforms.uSparkleDensity={value:I.sparkleDensity},qg(l,i,t,n),l.fragmentShader=Yg(a)+l.fragmentShader,l.fragmentShader=l.fragmentShader.replace("#include <normal_fragment_maps>",`#include <normal_fragment_maps>
`+$g(s)).replace("#include <color_fragment>",`#include <color_fragment>
...
R.leftArm.rotation.z=.16-O*.17+D*.1,R.rightArm.rotation.z=-.16-O*.17-D*.1,R.leftArm.rotation.x=-.5+S*.08+D*.18,R.rightArm.rotation.x=-.5+S*.08-D*.18,R.leftLeg.rotation.x=.16+N*.42+P*.25-D*.16,R.rightLeg.rotation.x=.16+N*.42+P*.25-D*.16,R.leftLeg.rotation.z=.05-O*.1,R.rightLeg.rotation.z=-.05-O*.1}this.contact.set(this.position.x,l,this.position.z);const c=wt.clamp(o/I.cruiseSpeed,.4,1.6);this.carveIntensity=wt.clamp(Math.abs(this.steer)*c+this.landImpact*I.landImpactCarve,0,1)}}const Hc={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Ni.BlurDirectionX=new j(1,0);Ni.BlurDirectionY=new j(0,1);const o0={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
  ...
  `},c0={uniforms:{tDiffuse:{value:null},uLift:{value:new pe("#101a2e")},uGain:{value:new pe("#fff4e4")},uSaturation:{value:1.1},uContrast:{value:1.16},uExposure:{value:1},uVignette:{value:.42},uAspect:{value:1},uSunPos:{value:new j(.5,.5)},uFlare:{value:0},uFlareColor:{value:new pe("#ffe9cf")}},vertexShader:Gc.vertexShader,fragmentShader:`
    precision highp float;
    uniform sampler2D tDiffuse;
    uniform vec3 uLift;
    uniform vec3 uGain;
  ...
  `};class Vc{constructor(e,t,n,s={msaa:4,godRays:!0,bloom:!0}){this.renderer=e,this.camera=n,this.quality=s;const r=e.getDrawingBufferSize(new j),a=new It(r.x,r.y,{type:sn,samples:s.msaa,colorSpace:bn});this.composer=new s0(e,a),this.composer.addPass(new r0(t,n)),this.godRays=new qa(Gc),this.godRays.enabled=s.godRays,this.composer.addPass(this.godRays),this.bloom=new Ni(new j(r.x,r.y),.38,.85,1.4),this.bloom.enabled=s.bloom,this.composer.addPass(this.bloom),this.flareStrength=.55,this.godRayStrength=.18,this.sunScreenLagX=6,this.sunScreenLagY=2,this._sunSmooth=new j(.5,.5),this._sunSmoothed=!1,this._wasBehind=!1,this.grade=new qa(c0),this.composer.addPass(this.grade),this.composer.addPass(new l0),this._sunWorld=new A,this._proj=new A,this._flareSmooth=new j}updateSun(e,t=1/60){this.camera.updateMatrixWorld(!0),this._sunWorld.copy(e).multiplyScalar(1800).add(this.camera.position),this._proj.copy(this._sunWorld).project(this.camera);const n=this._proj.z>1,s=this._proj.x*.5+.5,r=this._proj.y*.5+.5;if(!(Number.isFinite(s)&&Number.isFinite(r)))return;if(!this._sunSmoothed||n!==this._wasBehind||!Number.isFinite(this._sunSmooth.x)||!Number.isFinite(this._sunSmooth.y))this._sunSmooth.set(s,r),this._sunSmoothed=!0;else{const p=Math.min(1,t*this.sunScreenLagX),f=Math.min(1,t*this.sunScreenLagY);this._sunSmooth.x+=(s-this._sunSmooth.x)*p,this._sunSmooth.y+=(r-this._sunSmooth.y)*f}const o=Math.min(1,t*22);!Number.isFinite(this._flareSmooth.x)||n!==this._wasBehind?this._flareSmooth.set(s,r):(this._flareSmooth.x+=(s-this._flareSmooth.x)*o,this._flareSmooth.y+=(r-this._flareSmooth.y)*o),this._wasBehind=n;const l=this._sunSmooth.x,c=this._sunSmooth.y,h=Math.max(0,Math.abs(l-.5)-.5),u=Math.max(0,Math.abs(c-.5)-.5),d=Math.sqrt(h*h+u*u),m=wt.clamp(1-d/.55,0,1),g=this.grade.uniforms;if(g.uSunPos.value.set(this._flareSmooth.x,this._flareSmooth.y),g.uFlare.value=n?0:this.flareStrength*m,!this.godRays.enabled)return;const x=this.godRays.uniforms;x.uSunPos.value.set(l,c),x.uIntensity.value=n?0:this.godRayStrength*m}setSize(e,t){this.composer.setSize(e,t),this.bloom.setSize(e,t),this.grade.uniforms.uAspect.value=e/t}render(e){this.composer.render(e)}dispose(){this.composer.renderTarget1.dispose(),this.composer.renderTarget2.dispose(),this.bloom.dispose(),this.godRays.dispose?.(),this.grade.dispose?.()}}class h0{constructor({count:e=24e3,box:t=260,height:n=8}={}){this.box=t;const s=new Float32Array(e*3);for(let a=0;a<e*3;a++)s[a]=Math.random();const r=new Ut;r.setAttribute("aSeed",new vt(s,3)),r.setAttribute("position",new vt(new Float32Array(e*3),3)),r.boundingSphere=new ai(new A,1e6),this.material=new ft({transparent:!0,depthWrite:!1,blending:Nn,uniforms:{uTime:ye.uTime,uSunDir:ye.uSunDir,uSunColor:ye.uSunColor,uSkyHorizon:ye.uSkyHorizon,uSkyMid:ye.uSkyMid,uSkyZenith:ye.uSkyZenith,uSkyGround:ye.uSkyGround,uSkyBand:ye.uSkyBand,uOrigin:{value:new A},uBox:{value:t},uHeight:{value:n},uWind:{value:new j(I.windX,I.windZ)},uSpeed:{value:I.spindriftSpeed},uAmount:{value:I.spindriftAmount},uSize:{value:I.spindriftSize},uPixelRatio:{value:1}},vertexShader:`
      ...
      `}),vo(this.material,["uSunDir","uSunColor","uSkyHorizon","uSkyMid","uSkyZenith","uSkyGround","uSkyBand","uSunHalo","uSunDiscBright"]),this.points=new Tc(n,this.material),this.points.frustumCulled=!1,this.points.renderOrder=6}update(e,t,n){for(let r=0;r<Jt;r++)this.trailAge[r]+=t;this._acc=(this._acc??0)+t;const s=1/60;for(;this._acc>=s;){this._acc-=s;const r=this.head;this.trailPos[r*3+0]=e.position.x,this.trailPos[r*3+1]=e.position.y,this.trailPos[r*3+2]=e.position.z;const a=e.heading??e.forward,o=e.speed??0;this.trailVel[r*3+0]=a.x*o,this.trailVel[r*3+1]=a.y*o,this.trailVel[r*3+2]=a.z*o,this.trailAge[r]=0,this.trailRate[r]=e.grounded?n:0,this.head=(this.head+1)%Jt}this.material.uniforms.uTrailPos.value=this.trailPos,this.material.uniforms.uTrailVel.value=this.trailVel,this.material.uniforms.uTrailAge.value=this.trailAge,this.material.uniforms.uTrailRate.value=this.trailRate}dispose(){this.points.geometry.dispose(),this.material.dispose()}}const Dl=new URLSearchParams(location.search),Wc=Dl.has("q")?Number(Dl.get("q")):null,hs=matchMedia("(max-width: 700px), (hover: none) and (pointer: coarse)").matches,d0=wn.findIndex(i=>i.name==="medium");function f0(){const i=document.createElement("canvas"),e=i.getContext("webgl2")||i.getContext("webgl"),t=e&&e.getExtension("WEBGL_debug_renderer_info"),s=(t?String(e.getParameter(t.UNMASKED_RENDERER_WEBGL)):"").toLowerCase();return/swiftshader|basic render|llvmpipe|software/.test(s)?wn.length-1:/uhd graphics|hd graphics|iris|vega \d|radeon graphics|mali|adreno|apple gpu|powervr/.test(s)?wn.length-2:I.startLevel}let ri=wt.clamp(hs?d0:Wc??f0(),0,wn.length-1),je=wn[ri];const Ne=new _g({antialias:!1,powerPreference:"high-performance",stencil:!1});Ne.setPixelRatio(Math.min(window.devicePixelRatio,2)*je.renderScale);Ne.setSize(window.innerWidth,window.innerHeight);Ne.toneMapping=Ja;Ne.toneMappingExposure=.88;Ne.outputColorSpace=Qt;Ne.shadowMap.enabled=je.shadows;function Xc(){return Vl}Ne.shadowMap.type=Xc();document.body.appendChild(Ne.domElement);const _t=new Ec,ut=new Wt(I.fovCruise,window.innerWidth/window.innerHeight,.3,3200),qc=Fc();_t.add(qc);
let es=null;_t.environment=null;
const rt=new Bg(I.sunColor,I.sunIntensity);rt.castShadow=je.shadows;rt.shadow.mapSize.set(je.shadowMapSize,je.shadowMapSize);rt.shadow.camera.near=300;rt.shadow.camera.far=345;rt.shadow.camera.left=-14;rt.shadow.camera.right=I.shadowExtent;rt.shadow.camera.top=I.shadowExtent;rt.shadow.camera.bottom=-14;rt.shadow.bias=-6e-4;rt.shadow.normalBias=.4;rt.shadow.radius=3;_t.add(rt);_t.add(rt.target);
const Ys=new Fg(new pe("#9dc0ff"),new pe("#ffc08a"),1.15);_t.add(Ys);
const nightMoon=new Dt(new os(34,48,32),Xn({color:new pe("#ffffff"),emissive:new pe("#ffffff"),emissiveIntensity:10,roughness:.4})),nightMoonGlowGeo=new Ut;nightMoonGlowGeo.setAttribute("position",new vt(new Float32Array([0,0,0]),3));const nightMoonGlow=new Tc(nightMoonGlowGeo,new ft({transparent:!0,depthTest:!1,depthWrite:!1,vertexShader:"void main(){vec4 p=modelViewMatrix*vec4(position,1.0);gl_PointSize=240.0;gl_Position=projectionMatrix*p;}",fragmentShader:"void main(){float d=length(gl_PointCoord-.5)*2.0;float core=1.0-smoothstep(.28,.46,d);float halo=(1.0-smoothstep(.3,1.0,d))*.84;float white=1.0-smoothstep(.3,.62,d);gl_FragColor=vec4(mix(vec3(.18,.62,1.0),vec3(1.0),white),max(core,halo));}"}));nightMoonGlow.renderOrder=2,nightMoon.add(nightMoonGlow),nightMoon.visible=!1,nightMoon.renderOrder=3,_t.add(nightMoon);
const nightStarsGeo=new Ut,nightStarsPos=new Float32Array(960),nightStarsSize=new Float32Array(320);for(let i=0;i<320;i++){const e=Math.random()*Math.PI*2,t=.12+Math.random()*.74,n=640+Math.random()*760;nightStarsPos[i*3]=Math.cos(e)*Math.sqrt(1-t*t)*n,nightStarsPos[i*3+1]=t*n,nightStarsPos[i*3+2]=Math.sin(e)*Math.sqrt(1-t*t)*n,nightStarsSize[i]=.8+Math.random()*1.9}nightStarsGeo.setAttribute("position",new vt(nightStarsPos,3)),nightStarsGeo.setAttribute("aSize",new vt(nightStarsSize,1));
const nightStars=new Tc(nightStarsGeo,new ft({transparent:!0,depthWrite:!1,vertexShader:"attribute float aSize;varying float vSize;void main(){vSize=aSize;vec4 p=modelViewMatrix*vec4(position,1.0);gl_PointSize=max(1.5,aSize*220.0/-p.z);gl_Position=projectionMatrix*p;}",fragmentShader:"varying float vSize;void main(){float d=length(gl_PointCoord-.5);float a=smoothstep(.5,.18,d);gl_FragColor=vec4(vec3(.78,.86,1.0),a);}"}));nightStars.visible=!1,nightStars.frustumCulled=!1,nightStars.renderOrder=4,_t.add(nightStars);
function createNightAurora(i,e,t){const n=new Ut,r=[],s=[],a=[],o=56;for(let l=0;l<=o;l++){const c=l/o,h=(c-.5)*1700,u=-80,d=1120;r.push(h,u,-900,h,d,-900),s.push(c,0,c,1)}for(let l=0;l<o;l++){const c=l*2;a.push(c,c+1,c+2,c+1,c+3,c+2)}n.setAttribute("position",new vt(new Float32Array(r),3)),n.setAttribute("uv",new vt(new Float32Array(s),2)),n.setIndex(a);const l=new ft({transparent:!0,depthTest:!1,depthWrite:!1,side:2,uniforms:{uTime:{value:0},uColor:{value:new pe(i)},uPhase:{value:e},uStrength:{value:t}},vertexShader:"varying vec2 vUv;uniform float uTime;uniform float uPhase;void main(){vUv=uv;vec3 p=position;p.x+=sin(uv.y*5.0+uv.x*6.0+uTime*.05+uPhase)*12.0;gl_Position=projectionMatrix*modelViewMatrix*vec4(p,1.0);}",fragmentShader:"varying vec2 vUv;uniform float uTime;uniform float uPhase;uniform vec3 uColor;uniform float uStrength;float ribbon(float y,float c,float w){return exp(-pow((y-c)/w,2.0));}void main(){float x=vUv.x,y=vUv.y;float wave1=.38+.20*sin(x*5.0+uPhase+uTime*.025)+.08*sin(x*13.0-uPhase);float wave2=.66+.15*sin(x*4.0-uPhase*1.7-uTime*.018)+.07*sin(x*11.0+uPhase);float band=ribbon(y,wave1,.06)+.62*ribbon(y,wave2,.09);float edge=smoothstep(.01,.13,x)*(1.0-smoothstep(.87,.99,x));float shimmer=.82+.18*sin(x*30.0+uTime*.14+uPhase);float alpha=band*edge*shimmer*uStrength;gl_FragColor=vec4(uColor,alpha);}"}),c=new Dt(n,l);return c.visible=!1,c.frustumCulled=!1,c.renderOrder=1,_t.add(c),c}const nightAurora=[createNightAurora("#37e9d8",.2,.23),createNightAurora("#35bce7",2.4,.16),createNightAurora("#8adfbd",4.6,.1)];
function Yc(i){const e=si[i];if(e){I.look=i,I.sunDir.copy(e.sunDir).normalize(),ye.uSunDir.value.copy(I.sunDir),I.sunColor.set(e.sunColor),ye.uSunColor.value.set(e.sunColor),rt.color.set(e.sunColor),rt.intensity=e.sunIntensity;for(const t of["skyHorizon","skyMid","skyZenith","skyGround"])I[t].set(e[t]),ye["u"+t[0].toUpperCase()+t.slice(1)].value.set(e[t]);ye.uSkyBand.value=e.skyBand,ye.uSunDiscBright.value=e.sunDiscBright,ye.uSunHalo.value=e.sunHalo,Pt&&(Pt.flareStrength=e.flare,Pt.godRayStrength=e.godRays),ye.uCloudAmount.value=e.cloudAmount,ye.uCloudOpacity.value=e.cloudOpacity,ye.uCloudHeight.value=e.cloudHeight,ye.uCloudScale.value=e.cloudScale,ye.uCloudColor.value.set(e.cloudColor),Ys.color.set(e.hemiSky),Ys.groundColor.set(e.hemiGround),Ys.intensity=e.hemiIntensity,I.envIntensity=e.envIntensity,vn?.setEnvironmentIntensity(e.envIntensity),ye.uFogDensity.value=I.fogDensity=e.fogDensity,ye.uHazeDensity.value=I.hazeDensity=e.hazeDensity,ye.uHazeHeight.value=I.hazeHeight=e.hazeHeight,ye.uHazeBase.value=I.hazeBase=e.hazeBase,I.sssColor.set(e.sssColor),I.shadowTint.set(...e.shadowTint),I.sunTint.set(...e.sunTint),ye.uTintStrength.value=I.tintStrength=e.tintStrength,ye.uLitScale.value=I.litScale=e.litScale,ye.uSparkleStrength.value=I.sparkleStrength=e.sparkleStrength,ye.uHoarStrength.value=I.hoarStrength=e.hoarStrength??1,ye.uShadowDist.value=I.sunShadowDist=e.sunShadowDist,ye.uShadowStrength.value=I.sunShadowStrength=e.sunShadowStrength,I.spindriftAmount=e.spindriftAmount,Ne.toneMappingExposure=e.exposure,es?.dispose?.(),es=Oc(Ne),
je.envMap&&(_t.environment=es),nightMoon.visible=i==="night",nightStars.visible=i==="night",nightAurora.forEach(t=>t.visible=i==="night")
}
}let vn=new Bc(je);_t.add(vn.group);const Ue=new n0;_t.add(Ue.object);let Ln=null;function $c(){Ln&&(_t.remove(Ln.points),Ln.dispose(),Ln=null),je.spindrift&&(Ln=new u0({count:Math.min(9e3,je.spindrift)}),_t.add(Ln.points))}let Zn=null;function Kc(){Zn&&(_t.remove(Zn.points),Zn.dispose(),Zn=null),je.spindrift&&(Zn=new h0({count:je.spindrift}),_t.add(Zn.points))}Kc();$c();let Ya=new kc(Ne,je.deformRes),Pt=new Vc(Ne,_t,ut,je);Pt.setSize(window.innerWidth,window.innerHeight);
function $a(i){ri=wt.clamp(i,0,wn.length-1),je=wn[ri];if(hs){Ne.setPixelRatio(Math.min(window.devicePixelRatio,2)*je.renderScale),Ne.setSize(window.innerWidth,window.innerHeight),rt.shadow.mapSize.set(je.shadowMapSize,je.shadowMapSize),rt.shadow.map?.dispose(),rt.shadow.map=null;const e=Xc(),t=Ne.shadowMap.enabled!==je.shadows||Ne.shadowMap.type!==e;Ne.shadowMap.enabled=je.shadows,Ne.shadowMap.type=e,rt.castShadow=je.shadows,rt.shadow.bias=-6e-4,rt.shadow.normalBias=.4,_t.environment=je.envMap?es:null,t&&_t.traverse(n=>{n.material&&(n.material.needsUpdate=!0)}),vn.dispose(),vn=new Bc(je),_t.add(vn.group),Kc(),$c(),vn.follow(Ue.position),Ya.dispose(),Ya=new kc(Ne,je.deformRes),Pt.dispose(),Pt=new Vc(Ne,_t,ut,je),Pt.flareStrength=si[I.look]?.flare??Pt.flareStrength,Pt.godRayStrength=si[I.look]?.godRays??Pt.godRayStrength,vn.setEnvironmentIntensity(I.envIntensity??.85),Pt.setSize(window.innerWidth,window.innerHeight),Zc(),Jc();return}Ne.setPixelRatio(Math.min(window.devicePixelRatio,2)*je.renderScale),Ne.setSize(window.innerWidth,window.innerHeight),_t.environment=je.envMap?es:null,Pt.bloom.enabled=je.bloom,Pt.godRays.enabled=je.godRays,Pt.flareStrength=si[I.look]?.flare??Pt.flareStrength,Pt.godRayStrength=si[I.look]?.godRays??Pt.godRayStrength,Pt.setSize(window.innerWidth,window.innerHeight),Zc(),Jc()}
const Un=document.getElementById("quality");
let tr=0;function p0(i){Un&&(Un.textContent=i,Un.style.opacity="1",clearTimeout(tr),tr=setTimeout(()=>Un.style.opacity="0",2600))}function Zc(){Un&&(Un.textContent=`${je.name}${Wc!==null?" (pinned)":""}`,Un.style.opacity="1",clearTimeout(tr),tr=setTimeout(()=>Un.style.opacity="0",2200))}addEventListener("keydown",i=>{i.code==="BracketLeft"&&$a(ri+1),i.code==="BracketRight"&&$a(ri-1),i.code==="F3"&&Ka?.classList.toggle("hidden")});const Ka=document.getElementById("hud"),Ll=document.getElementById("mobile-fps");let Il=0;const ts=Ne.getContext().getExtension("EXT_disjoint_timer_query_webgl2"),ns=[],$s=[];let nr=0,is=null,Ul=0,bi="";{const i=Ne.getContext(),e=i.getExtension("WEBGL_debug_renderer_info");bi=e?String(i.getParameter(e.UNMASKED_RENDERER_WEBGL)):"unknown";const t=bi.match(/^ANGLE \([^,]+,\s*(.+?)(?:\s*\(0x|\s+Direct3D|\s+vs_|,)/);t&&(bi=t[1]),bi=bi.replace(/\((R|TM)\)/g,"").replace(/\s+/g," ").trim()}function m0(){if(!ts||is)return;const i=Ne.getContext().createQuery();Ne.getContext().beginQuery(ts.TIME_ELAPSED_EXT,i),is=i}function g0(){const i=Ne.getContext();if(!ts||!is)return;i.endQuery(ts.TIME_ELAPSED_EXT);const e=is;is=null,setTimeout(()=>{if(!i.getQueryParameter(e,i.QUERY_RESULT_AVAILABLE))return i.deleteQuery(e);i.getParameter(ts.GPU_DISJOINT_EXT)||(nr=nr*.8+i.getQueryParameter(e,i.QUERY_RESULT)/1e6*.2),i.deleteQuery(e)},60)}function Jr(i){if(!i.length)return 0;const e=[...i].sort((t,n)=>t-n);return e[e.length>>1]}function v0(i){if(hs&&Ll&&i-Il>=400&&(Il=i,Ll.textContent=`${(1e3/(Jr(ns)||1)).toFixed(0)} FPS`),!Ka||i-Ul<400)return;Ul=i;const e=Jr(ns),t=Ne.getDrawingBufferSize(new j),n=Ne.info.render.triangles;Ka.innerHTML=`<span class="big">${(1e3/(e||1)).toFixed(0)} fps</span>  ${e.toFixed(1)} ms
...
F3 hides this`}const jt=new Set,kt={steer:0,forward:!1,boost:!1},_0=document.getElementById("mobile-quality"),Nl=document.getElementById("mobile-quality-value"),x0=document.getElementById("mobile-background"),Fl=document.getElementById("mobile-background-value"),jr=document.getElementById("mobile-boost"),Ol=document.getElementById("mobile-boost__value");function Jc(){!hs||!Nl||(Nl.textContent=je.name[0].toUpperCase()+je.name.slice(1))}function jc(){!hs||!Fl||(Fl.textContent=si[I.look]?.label||I.look)}function Qc(){const i=Object.keys(si);Yc(i[(i.indexOf(I.look)+1)%i.length]),jc()}if(hs){_0?.addEventListener("click",()=>{$a((ri-1+wn.length)%wn.length)}),x0?.addEventListener("click",Qc),jr?.addEventListener("click",()=>{kt.boost=!kt.boost,jr.classList.toggle("is-on",kt.boost),jr.setAttribute("aria-pressed",String(kt.boost)),Ol&&(Ol.textContent=kt.boost?"On":"Off")});let i=null,e=0,t=0;const n=()=>{i=null,kt.steer=0,kt.forward=!1};Ne.domElement.style.touchAction="none",Ne.domElement.addEventListener("pointerdown",s=>{s.pointerType==="mouse"||i!==null||(i=s.pointerId,e=s.clientX,t=s.clientY,Ne.domElement.setPointerCapture?.(s.pointerId))}),Ne.domElement.addEventListener("pointermove",s=>{if(s.pointerId!==i)return;const r=s.clientX-e,a=s.clientY-t;kt.forward=a<-16,kt.steer=Math.abs(r)<12?0:wt.clamp(-r/70,-1,1)}),Ne.domElement.addEventListener("pointerup",n),Ne.domElement.addEventListener("pointercancel",n),Ne.domElement.addEventListener("lostpointercapture",n)}addEventListener("keydown",i=>{jt.add(i.code),["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Space"].includes(i.code)&&i.preventDefault(),i.code==="KeyM"&&(ye.uRuler.value=ye.uRuler.value>.5?0:1,p0(ye.uRuler.value>.5?"distance rings: green every 5 m, red every 25 m":"distance rings off")),i.code==="KeyL"&&Qc()});addEventListener("keyup",i=>jt.delete(i.code));addEventListener("blur",()=>jt.clear());function S0(){let i=0;return(jt.has("KeyA")||jt.has("ArrowLeft"))&&(i+=1),(jt.has("KeyD")||jt.has("ArrowRight"))&&(i-=1),{steer:wt.clamp(i+kt.steer,-1,1),forward:jt.has("KeyW")||jt.has("ArrowUp")||kt.forward||kt.boost,boost:jt.has("ShiftLeft")||jt.has("ShiftRight")||kt.boost}}const qn=new A,Yi=new A,Qr=new A,Mi=new A,ea=new A,ta=new A,zl=new A,Bl=new A,eh=new A,th=new A;let zs=0,Yn=0,kl=!1,Ci="waiting",Ks=0;function y0(i){return i=wt.clamp(i,0,1),i*i*(3-2*i)}function nh(){Ci==="waiting"&&(Ci="transitioning",Ks=0,eh.copy(ut.position),ut.getWorldDirection(th).multiplyScalar(45).add(ut.position),document.getElementById("start-screen")?.classList.add("leaving"))}function M0(i){let e=Ue.yaw-zs;e=Math.atan2(Math.sin(e),Math.cos(e)),zs+=e*Math.min(1,i*3);const t=-Math.sin(zs),n=-Math.cos(zs),s=I.camOffset,r=s.z+Ue.boost*1.6;Qr.set(-t*r+n*s.x,s.y,-n*r-t*s.x),kl?Yi.lerp(Qr,Math.min(1,i*I.camLag)):(Yi.copy(Qr),Yn=Ue.position.y,kl=!0);const a=Ue.grounded?I.camHeightLagGround:I.camHeightLagAir;Yn+=(Ue.position.y-Yn)*Math.min(1,i*a);const o=Ue.grounded?I.camHeightLead:I.camHeightLeadAir;Yn=wt.clamp(Yn,Ue.position.y-o,Ue.position.y+o),qn.copy(Ue.position).add(Yi),qn.y=Yn+Yi.y;const l=ti(qn.x,qn.z)+1.5;qn.y<l&&(qn.y=l),ea.copy(qn);const c=Yn+Yi.y-I.camPitchDrop,h=Ue.position.y+I.camLookHeight;if(Mi.set(Ue.position.x+t*I.camLookAhead,wt.lerp(c,h,I.camPitchFollow),Ue.position.z+n*I.camLookAhead),ta.copy(Mi),Ci==="waiting")zl.set(Ue.position.x-t*38,Ue.position.y+15,Ue.position.z-n*38),Bl.set(Ue.position.x+t*5,Ue.position.y+1.2,Ue.position.z+n*5),ut.position.lerp(zl,Math.min(1,i*1.6)),Mi.lerp(Bl,Math.min(1,i*1.6)),ut.lookAt(Mi);else if(Ci==="transitioning"){Ks+=i/3.4;const d=y0(Ks);ut.position.lerpVectors(eh,ea,d),Mi.lerpVectors(th,ta,d),ut.lookAt(Mi),Ks>=1&&(Ci="playing")}else ut.position.copy(ea),ut.lookAt(ta);const u=wt.lerp(I.fovCruise,I.fovBoost,Ue.boost);Math.abs(ut.fov-u)>.01&&(ut.fov+=(u-ut.fov)*Math.min(1,i*4),ut.updateProjectionMatrix())}const w0=new Ic;let na=0;function b0(i){if(na+=i,ye.uTime.value=na,ye.uRulerOrigin.value.set(Ue.position.x,Ue.position.z),ye.uTexOrigin.value.set(Math.round(Ue.position.x/1024)*1024,Math.round(Ue.position.z/1024)*1024),ye.uCloudTime.value=na,Ue.update(i,Ci==="playing"?S0():{steer:0,forward:!1,boost:!1}),Ya.update(i,Ue.position,Ue.contact,Ue.carveIntensity,Ue.carving),vn.follow(Ue.position),
rt.position.copy(Ue.position).addScaledVector(I.sunDir,320),nightMoon.position.copy(Ue.position).addScaledVector(I.sunDir,900),
rt.target.position.copy(Ue.position),rt.target.updateMatrixWorld(),M0(i),nightStars.position.copy(ut.position),nightAurora.forEach(e=>{e.position.copy(ut.position),e.quaternion.copy(ut.quaternion),e.material.uniforms.uTime.value=na}),
qc.position.copy(ut.position),Zn?.update(ut,Ne.getPixelRatio()),Ln){const e=Math.abs(Ue.steer),t=wt.clamp((Ue.speed-I.idleSpeed)/(I.maxSpeed-I.idleSpeed),0,1),n=wt.clamp(t*(.18+1.15*e),0,1);Ln.update(Ue,i,n)}Pt.updateSun(I.sunDir,i),Pt.render(i)}let Hl=performance.now();function ih(){requestAnimationFrame(ih);const i=performance.now(),e=i-Hl;Hl=i,Ne.info.autoReset=!1,Ne.info.reset(),m0(),b0(Math.min(w0.getDelta(),1/20)),g0();const t=performance.now()-i;ns.push(e),$s.push(t),ns.length>60&&ns.shift(),$s.length>60&&$s.shift(),v0(i)}addEventListener("resize",()=>{const i=window.innerWidth,e=window.innerHeight;ut.aspect=i/e,ut.updateProjectionMatrix(),Ne.setSize(i,e),Pt.setSize(i,e)});const sh=document.getElementById("start-screen");sh?.addEventListener("click",nh);sh?.addEventListener("keydown",i=>{(i.code==="Enter"||i.code==="Space")&&(i.preventDefault(),nh())});
Yc(Gg);Ne.compileAsync(_t,ut).catch(()=>Ne.compile(_t,ut)).finally(()=>{Zc();ih();Jc();jc();requestAnimationFrame(()=>{document.getElementById("loading")?.classList.add("gone"),document.getElementById("hint")?.classList.add("fade")})});
