...
vec3 sunDisc(vec3 dir) {
  ...
  float disc = smoothstep(1.0-0.000025*uSunDiscScale,1.0-0.000008*uSunDiscScale,s)*uSunDiscBright;
...
sunColor:"#ffffff",sunIntensity:1.42,skyHorizon:"#176998",skyMid:"#0d3e6a",skyZenith:"#04142f",skyGround:"#155d88",skyBand:.52,sunDiscBright:265,sunDiscScale:2.7,sunHalo:1.45,flare:0,godRays:0,cloudAmount:.12,cloudOpacity:.33,cloudHeight:1500,cloudScale:.0012,cloudColor:"#78bfe8",hemiSky:"#58bee9",hemiGround:"#173859",hemiIntensity:.72,envIntensity:.5,fogDensity:.001,hazeDensity:.0018,hazeHeight:20,hazeBase:-8,sssColor:"#a8edff",shadowTint:[.32,.55,.78],sunTint:[.7,.9,1.18],tintStrength:.33,litScale:2.5,sparkleStrength:3.1,hoarStrength:.55,sunShadowDist:230,sunShadowStrength:.82,exposure:.8,spindriftAmount:.12};
...
rt.position.copy(Ue.position).addScaledVector(I.sunDir,320),

rt.target.position.copy(Ue.position),rt.target.updateMatrixWorld(),M0(i),nightStars.position.copy(ut.position),
